...
parser.add_argument(
    ...
    type=str,
    default='cali_mmCIF')    #'mmCIF/files.rcsb.org/pub/pdb/data/structures/divided/mmCIF')
parser.add_argument(
    '--max_file_size',
    help='Max file size.',
    type=int,
    default=10000000)  # Only process files up to 10MB large.
parser.add_argument(
    '--min_file_size',
    help='Min file size.',
    type=int,
