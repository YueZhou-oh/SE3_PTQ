...
def calc_distogram(pos, min_bin, max_bin, num_bins):
    # print(pos.shape)    # torch.Size([1, 100, 3])
    # print(pos)  # initial poss are all zero during inference, but updated through rigid_t
    ...
    # print(dists_2d.shape) # torch.Size([1, 100, 100, 1])
    # print(lower.shape)  # torch.Size([22])
    # print(upper.shape)  # torch.Size([22])
    # print(dgram.shape)  # torch.Size([1, 100, 100, 22])
    # print(dgram)        
    return dgram
